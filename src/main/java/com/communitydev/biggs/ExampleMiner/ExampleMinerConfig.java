...
public interface ExampleMinerConfig extends Config {
    String GROUP_NAME = "minerConfig";
    @ConfigSection(
            name = "<html><font color=#b3f073>Example Miner v0.1</font></html>",
            description = "",
            position = 0,
  ...
  section = gearConfig)
   default String specWeapon() {
    ...
    default String instructions() {
        return "Please start the plugin at lumbridge swamp or bank.\n\n" +
                "This plugin will mine tin & copper at lumby swamp. and bank.";
    }
